...
import { ALargeSmall, Code, Droplet, FileCode, FileText, ImageIcon, Palette, Pipette, RotateCcw, SquareCode, Type } from 'lucide-vue-next'
...
const emit = defineEmits([`openPlatformContent`])
...
<template>
  ...
  <MenubarSub v-if="asSub">
    ...
    <MenubarSubContent class="w-56">
      ...
      <MenubarCheckboxItem class="pl-2" @click="emit('openPlatformContent')">
