    ...
    <main class="container-main flex flex-1 flex-col">
      ...
      >
        <ResizablePanelGroup direction="horizontal">
          <ResizablePanel
            :default-size="isOpenPostSlider ? (isPostSliderCollapsed ? 2 : 15) : 0"
            :max-size="isOpenPostSlider ? (isPostSliderCollapsed ? 2 : 20) : 0"
            :min-size="isOpenPostSlider ? (isPostSliderCollapsed ? 2 : 10) : 0"
          >
            <PostSlider />
          </ResizablePanel>
          <ResizableHandle v-if="isOpenPostSlider && !isPostSliderCollapsed" class="hidden md:block" />
          <ResizablePanel
            :default-size="isOpenFolderPanel ? (isFolderPanelCollapsed ? 2 : 15) : 0"
            :max-size="isOpenFolderPanel ? (isFolderPanelCollapsed ? 2 : 25) : 0"
            :min-size="isOpenFolderPanel ? (isFolderPanelCollapsed ? 2 : 10) : 0"
          >
            <FolderSourcePanel />
          </ResizablePanel>
          <ResizableHandle v-if="isOpenFolderPanel && !isFolderPanelCollapsed" class="hidden md:block" />
